...
public class RepairServiceImpl implements RepairService {
    ...
    public Repair getRepairByNoS(Integer repairNo,Integer staffNo) { return repairMapper.getRepairByNoS(repairNo,staffNo); }
    public Repair getRepairByNo(Integer repairNo) { return repairMapper.getRepairByNo(repairNo); }
    ...
    public void deleteRepair(Integer No) { repairMapper.deleteRepair(No); }
}
